                        ...
                        <div className="col-xl-8 col-lg-8 col-md-12">
                            ...
                            <div className="sx-latest-post-st-1 m-b50">
                                <div className="sx-post-media sx-img-effect img-reflection">
                                    <Link href="/blogs/detail"><ItodoImage src="images/blog/blog-grid-sidebar/pic1.jpg" alt="Image" /></Link>
                                </div>
                                <div className="sx-post-info p-t30">
                                    <div className="sx-post-meta ">
                                        <ul>
                                            <li className="post-date"><Link href="/blogs/detail"><i className="fa fa-calendar" />01 Jan 2023</Link></li>
                                            <li className="post-author"><Link href="/blogs/detail"><i className="fa fa-comments" />0 Comments</Link></li>
                                        </ul>
                                    </div>
                                    <div className="sx-post-title ">
                                        <h4 className="post-title"><Link href="/blogs/detail">Standard size business agency kal Consulat Latest Management.</Link></h4>
                                    ...
                                    <div className="sx-post-readmore">
                                        <Link href="/blogs/detail" title="READ MORE" rel="bookmark" className="site-button icon"><i className="fa  fa-long-arrow-right" />Read More</Link>
                                    </div>
                                </div>
                            </div>
                            {/*two*/}
                            <div className="sx-latest-post-st-1 m-b50">
                                <div className="sx-post-media sx-img-effect img-reflection">
                                    <Link href="/blogs/detail"><ItodoImage src="images/blog/blog-grid-sidebar/pic2.jpg" alt="Image" /></Link>
                                    <Link href="/https://www.youtube.com/watch?v=c1XNqw2gSbU" className="mfp-video circle-small">
                            ...
                            <div className="sx-latest-post-st-1 sx-no-image m-b50">
                                <div className="sx-post-info p-t30">
                                    ...
                                    <div className="sx-post-title ">
                                        <h4 className="post-title"><Link href="/blogs/detail">Standard size agency kal Consulat Latest Management.</Link></h4>
                                        <div className="sx-post-text">
                            ...
                            <div className="sx-latest-post-st-1 m-b50">
                                <div className="sx-post-media sx-img-effect img-reflection">
                                    <Link href="/blogs/detail"><ItodoImage src="images/blog/blog-grid-sidebar/pic3.jpg" alt="Image" /></Link>
                                    <Link href="/https://www.youtube.com/watch?v=c1XNqw2gSbU" className="mfp-video circle-small">
                                        <i className="fa fa-play" />
                                    </Link>
                                </div>
                            ...
                            <div className="sx-latest-post-st-1 m-b50">
                                <div className="sx-post-media sx-img-effect img-reflection">
                                    <Link href="/blogs/detail"><ItodoImage src="images/blog/blog-grid-sidebar/pic4.jpg" alt="Image" /></Link>
                                </div>
                                <div className="sx-post-info p-t30">
                                    <div className="sx-post-meta ">
                                        <ul>
