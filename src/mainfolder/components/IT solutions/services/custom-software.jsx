...
function Customsoftware() {
  ...
  return (
    <>
      ...
      <div className="section-full p-t110 mobile-page-padding pb-5 bg-black">
        <div className="container">
          ...
          <div className="section-content">
            ...
            <div className="section-head left">
              <div className="sx-head-s-title fw-bold">Branding Design</div>
                ...
                <div className="row">
                  <div className="col-lg-8 col-md-12">
                    <div className="sx-r-part-content">
                      <h2 className="sx-title text-white">
                        Our Success{" "}
                        <span style={{ color: "#ff0055" }}>Journey We</span> can
                        Provide.
                      </h2>
                      <p>
