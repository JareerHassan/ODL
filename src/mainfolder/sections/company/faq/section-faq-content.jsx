                ...
                <div className="row">
                    <div className="col-lg-7 col-md-12 ">
                        <div className="sx-acdn-style-1-section ">
                            <div className="accordion sx-acdn-style-1" id="sf-faq-accordion">
                                {/*One*/}
                                <div className="accordion-item bg-black text-white">
                                    <button className="accordion-button collapsed bg-black text-white" type="button" data-bs-toggle="collapse" data-bs-target="#FAQ1" aria-expanded="false">
                                ...
                                {/*Two*/}
                                <div className="accordion-item bg-black text-white">
                                    <button className="accordion-button bg-black text-white" type="button" data-bs-toggle="collapse" data-bs-target="#FAQ2" aria-expanded="true">
                                ...
                                {/*Three*/}
                                <div className="accordion-item bg-black text-white">
                                    <button className="accordion-button collapsed bg-black text-white" type="button" data-bs-toggle="collapse" data-bs-target="#FAQ3" aria-expanded="false">
                                        What should be listed on a business card?
                                    </button>
                                ...
                                {/*Four*/}
                                <div className="accordion-item bg-black text-white">
                                    <button className="accordion-button collapsed bg-black text-white" type="button" data-bs-toggle="collapse" data-bs-target="#FAQ4" aria-expanded="false">
                                ...
                                {/*Five*/}
                                <div className="accordion-item bg-black text-white">
                                    <button className="accordion-button collapsed bg-black text-white" type="button" data-bs-toggle="collapse" data-bs-target="#FAQ5" aria-expanded="false">
                                ...
                                {/*Six*/}
                                <div className="accordion-item bg-black text-white">
                                    <button className="accordion-button collapsed bg-black text-white" type="button" data-bs-toggle="collapse" data-bs-target="#FAQ6" aria-expanded="false">
                                        What should be listed on a business card?
                                    </button>
                    ...
                    <div className="col-lg-5 col-md-12">
                        <div className="aon-faq-1-media">
                            <ItodoImage src="images/services-5.webp" alt="#" />
                        </div>
                    </div>
                </div>
            </div>
