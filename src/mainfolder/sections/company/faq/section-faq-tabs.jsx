export default function SectionFAQTabs() {
    return(
        <>
            <ul className="nav nav-pills sx-tab-style-1 bg-black mb-4" role="tablist">
                ...
                <li className="nav-item">
                    <div className="nav-link bg-transparent border" data-bs-toggle="pill" data-bs-target="#day_2">
