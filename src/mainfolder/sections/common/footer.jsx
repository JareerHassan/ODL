...
function Footer() {
  return (
    <footer className="site-footer bg-black">
      ...
      {/* FOOTER CONTENT */}
      <div className="footer-top pt-5 pb-2 ms-3">
        <div>
          <div className="row gx-3 gy-3">
              ...
              <div className="widget widget_info">
                ...
                <ul style={{ paddingLeft: 0, marginBottom: 0 }}>
                  <li className="d-flex mb-2">
                    ...
                    <div>
                      <a href="tel:+49 160 90338154" style={{ textDecoration: "none" }}>
                        +49 160 90338154
                      </a>
                      <br />
                      <a href="tel:+971 562228179" style={{ textDecoration: "none" }}>
                        +971 562228179
                      </a>
                    </div>
                  </li>
            ...
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
              <div className="widget widget_insta-gallery">
                ...
                <ul className="d-flex flex-wrap p-0 m-0 gap-2">
                  {[1, 2, 3, 4,].map((num) => (
      ...
      <div>
        <div className="sx-f-bottom-section bg-transparent">
          <div className="sx-f-social">
            <ul>
              <li>
                <a href="https://www.facebook.com/oxmite/">
                  <i className="flaticon-facebook" />
                </a>
              </li>
              <li>
                <a href="https://twitter.com/oxmite/">
                  <i className="flaticon-twitter" />
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/oxmite/">
                  <i className="flaticon-linkedin" />
                </a>
              </li>
              <li>
                <a href="https://instagram.com/oxmite.digital.ltd">
